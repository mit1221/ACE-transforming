...
function addViewer(card) {
  ...
  if (current != card) {
    ...
    function createScopeIcon(scope, type) {
      ...
      icon.src = 'images/' + scope + '_progress_icon.svg';
